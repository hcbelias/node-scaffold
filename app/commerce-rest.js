...
const VALID_JSON_CONTENT_TYPES = ['application/json', 'application/json;charset=utf-8','application/json;charset=UTF-8'];
    ...
    function (resolve, reject) {
      ...
      self.request ({url : '/ccadmin/v1/login',
        ...
        callback : function (err, response) {
          response = Buffer.isBuffer(response) ? JSON.parse(response) : response;
